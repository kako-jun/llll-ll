...
//   - PE: JS 無効なら ☾ ボタンが無反応で残るだけ（既定ダーク・prefers-light なら自動ライト）で壊れない。
...
if (typeof module !== "undefined" && module.exports) {
  module.exports = { resolveTheme, nextTheme, bbsThemeFor, iconFor, STORAGE_KEY };
}
